import 'package:instagram_ui/instagram_app/models/postResponse.dart';

List<Map<String, dynamic>> postsResponselist = [
  {
    'user': {
      'name': 'hussam',
      'image':
...
// convert list of maps to list of PostsResponse 
// and give the data in maps to PostResponse 
List<PostsResponse> posts =
    postsResponselist.map((e) => PostsResponse.fromJson(e)).toList();